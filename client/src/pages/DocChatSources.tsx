    ...
    <div className="h-full p-8 overflow-auto">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
          ...
          {/* Documents List + Selected Document */}
            ...
            <div className="glass-card rounded-xl p-6">
              ...
              {documentsLoading ? (
                ...
                <div className="text-center py-8">
                  <div className="w-12 h-12 rounded-full bg-gradient-subtle mx-auto mb-3 flex items-center justify-center">
                ...
                <>
                      ...
                      return (
                        <div
                          ...
                          className={`group relative p-3 rounded-lg cursor-pointer transition-all duration-200 border ${
                            isSelected 
                              ...
                              : 'border-transparent hover:border-slate-200 dark:hover:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-900'
                          }`}
                        ...
                        >
                          <div className="flex items-center gap-3">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="flex items-center gap-2 mt-1">
                                <span className={`text-xs px-2 py-0.5 rounded-full ${
                                  ...
                                  doc.status === 'processing' ? 'bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-400' :
                            ...
                            {/* Selection Indicator */}
                            {isSelected && (
                              <CheckCircle2 className="w-5 h-5 text-purple-600 flex-shrink-0" data-testid={`selected-${doc.id}`} />
                            )}
                            ...
                            <Button
                              variant="ghost"
                              size="sm"
                              className="h-7 w-7 p-0 opacity-0 group-hover:opacity-100 hover:bg-destructive/10 hover:text-destructive transition-all duration-200"
                              onClick={(e) => {
                                e.stopPropagation();
                  ...
                  >
                    {startChatMutation.isPending ? (
                      ...
                      `Start Chat ${selectedDocs.length > 0 ? `(${selectedDocs.length})` : ''}`
                    )}
                  </Button>
                </>
              )}
